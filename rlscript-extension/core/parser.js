...
// core/parser.js - RLScript command parsing. PURE string logic, zero DOM:
...
const RLParse = (() => {
  ...
  // new RLScript schema ("command"/"params") and the legacy/function-calling
  ...
  // The assistant emitted a RLScript command (JSON or a ###LUA### block).
